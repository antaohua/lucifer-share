 ...
 */
@Mapper
public interface TdConceptMarketMapper extends BaseShardingMapper<BoardMarketEntity> {
     ...
     * @return 影响行数
     */
    int batchInsertOrUpdate(@Param("list") List<BoardMarketEntity> boardList, @Param("month") String month);
     ...
     * @return 概念板块实时数据列表
     */
    List<BoardMarketEntity> getRealtimeDataByCodeAndDate(@Param("boardCode") String boardCode,
