 ...
 */
@Mapper
public interface TdConceptMarketMapper extends BaseShardingMapper<TradeBoardMarketEntity> {
     ...
     * @return 影响行数
     */
    int batchInsertOrUpdate(@Param("list") List<TradeBoardMarketEntity> boardList, @Param("month") String month);
     ...
     * @return 概念板块实时数据列表
     */
    List<TradeBoardMarketEntity> getRealtimeDataByCodeAndDate(@Param("boardCode") String boardCode,
